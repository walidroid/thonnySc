...
begin
  ...
  begin
    ...
    begin
      WizardForm.WelcomeLabel2.Caption := 'This wizard will upgrade Thonny to version {#AppVer} for all users.';
      Upgraded := True;
    end;
  end
  else  // single user
  begin
    ...
    begin
      WizardForm.WelcomeLabel2.Caption := 'This wizard will upgrade Thonny to version {#AppVer} for your account.';
      Upgraded := True;
    end;
