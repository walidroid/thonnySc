...
class MainCPythonBackend(MainBackend):
    ...
    def _get_distributions_info(self) -> Dict[str, DistInfo]:
        ...
        # Prefer importlib.metadata (stdlib since Python 3.8) to avoid
        # depending on pkg_resources / setuptools which may not be installed.
        try:
        ...
        # Fallback: use pkg_resources if importlib.metadata failed
        try:
